...
class SchedulerService {
    constructor() {
        ...
        this.interval = config.scheduler.fetchIntervalCron;
        this.initialDelayMs = config.scheduler.initialDelayMs;
    ...
    getNextRunTime() {
        ...
        try {
            ...
            nextDay.setHours(0, 0, 0, 0); // Assuming cron runs at midnight
    ...
    getScheduleDescription() {
        const intervalHours = config.scheduler.fetchIntervalHours;
    ...
    healthCheck() {
        ...
        // Consider unhealthy if no run in more than 25 hours (allowing 1 hour buffer)
