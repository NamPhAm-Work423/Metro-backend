// Skip tracing initialization during tests
if (process.env.NODE_ENV === 'test' || process.env.JEST_WORKER_ID) {
  console.log('🚫 OpenTelemetry tracing disabled for tests');
  module.exports = {
    addCustomSpan: () => Promise.resolve(),
    createCustomSpan: () => Promise.resolve(),
    sdk: { start: () => Promise.resolve(), shutdown: () => Promise.resolve() },
  };
} else {
...
process.env.OTEL_SERVICE_NAME = process.env.SERVICE_NAME || 'ticket-service';
